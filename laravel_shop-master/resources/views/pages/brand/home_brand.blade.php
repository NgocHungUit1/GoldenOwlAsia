                ...
                <div class="productinfo text-center">
                    <form>
                        ...
                        <input type="hidden" value="{{$product->product_id}}" class="cart_product_id_{{$product->product_id}}">
                            ...
                            <input type="hidden"  id="wishlist_productprice{{$product->product_id}}"  value="{{number_format($product->product_price,0,',',',')}}$" class="cart_product_price_{{$product->product_id}}">
